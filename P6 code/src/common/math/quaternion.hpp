...
#ifndef AED_MATH_QUATERNION_HPP_
#define AED_MATH_QUATERNION_HPP_
...
public:
     ...
     */
    void from_matrix( const Matrix3& mat );

    /**
     * Converts from axis.
     */
    void from_axis( const Vector3& x, const Vector3& y, const Vector3& z);
...
#endif /* AED_MATH_QUATERNION_HPP_ */
